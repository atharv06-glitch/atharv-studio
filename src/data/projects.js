export const PROJECTS = [
  { 
    id: 1, 
    title: 'Tassya Silver', 
    type: 'E-commerce / Jewelry', 
    img: 'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?q=80&w=2000&auto=format&fit=crop',
    overview: 'A premium e-commerce experience crafted for Tassya Silver, highlighting their beautiful jewelry collections with a seamless shopping experience.',
    client: 'Tassya Silver',
    year: '2026',
    services: ['Web Design', 'E-commerce Development'],
    link: 'https://tassyasilver.com'
  },
  { 
    id: 2, 
    title: 'Rhisome Advertising', 
    type: 'Agency / Portfolio', 
    img: 'https://images.unsplash.com/photo-1542744173-8e7e53415bb0?q=80&w=2000&auto=format&fit=crop',
    overview: 'A striking digital portfolio for Rhisome Advertising, showcasing their creative campaigns and strategic marketing services.',
    client: 'Rhisome Advertising',
    year: '2026',
    services: ['Web Design', 'Development', 'Brand Strategy'],
    link: 'https://rhisomeadvertising.com/'
  },
  { 
    id: 3, 
    title: 'Greenvale', 
  ...
  },
  {
    ...
    overview: 'A comprehensive digital presence for Ador Group, reflecting their legacy and extensive manufacturing operations.',
    client: 'Ador Group',
    year: '2026',
    services: ['Web Design', 'Enterprise Development'],
  ...
  },
  {
    ...
    overview: 'A modern platform illustrating digital transformation solutions for the manufacturing and industrial sectors.',
    client: 'Digital Transformation Services',
    year: '2026',
  ...
  },
  {
    ...
    overview: 'A trusted digital gateway for IntegriMedical, featuring their innovative medical devices and healthcare solutions.',
    client: 'IntegriMedical',
    year: '2026',
    services: ['Web Design', 'Medical Compliance'],
  ...
  // --- E-commerce ---
  {
    ...
    overview: 'A vibrant e-commerce platform for Green Tokri, offering farm-fresh produce with a seamless checkout experience.',
    client: 'Green Tokri',
    year: '2026',
  ...
  // --- Real Estate & Portfolio ---
  {
    ...
    overview: 'A dynamic portfolio showcasing innovative real estate concepts and architectural designs for Vconnect Idees.',
    client: 'Vconnect Idees',
    year: '2026',
    services: ['Web Design', 'Portfolio Development'],
  ...
  },
  {
    ...
    overview: 'A forward-thinking digital showcase for Regen Fiber, emphasizing sustainable real estate and building materials.',
    client: 'Regen Fiber',
    year: '2026',
